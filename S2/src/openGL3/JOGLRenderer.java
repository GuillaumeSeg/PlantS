...
public class JOGLRenderer implements GLEventListener {
	...
	int m_NbTrunkPositionVertices;
	FloatBuffer m_VerticesLeafPosition;
	int m_NbLeafPositionVertices;
	...
	public void init(GLAutoDrawable drawable) {
		...
		m_NbTrunkPositionVertices = 2; //verticesTrunkPosition.length/3;
		...
		m_NbLeafPositionVertices = 4;//verticesLeafPosition.length/3;
	...
	private void drawPrimitiveTrunk(GL3 gl){
        ...
        gl.glUniformMatrix4fv(m_MVPLocation, 1, false, m_MatrixStack.parseTopToFloatArray(), 0);
        gl.glDrawArrays(GL3.GL_LINES, 0, m_NbTrunkPositionVertices);
	}
	...
	private void drawPrimitiveLeaf(GL3 gl){
        ...
        gl.glUniformMatrix4fv(m_MVPLocation, 1, false, m_MatrixStack.parseTopToFloatArray(), 0);
        gl.glDrawArrays(GL3.GL_TRIANGLE_FAN, 0, m_NbLeafPositionVertices);
	}
