...
public class JOGLRenderer implements GLEventListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		matrixStack.translate(new Vector3d(2.0, 0.5, 3));
		matrixStack.scale(2.0d);
